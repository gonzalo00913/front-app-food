    ...
    <section className={Style.sectionParrafo}>
      ...
      <div className={Style.containerImgParrafo}>
        <p className={Style.parrafo}>
          Homemade Delights is an application that allows you to discover and
          explore more than 100 recipes. You can see the details of each recipe,
          search for them by name, filter them and also create your own recipes.
        </p>
      </div>
       </section>
