    ...
    <div className={Style.filterAllContainer}>
      <div className={Style.filterOneContainer}>
        ...
        <select
          ...
          id="filter-type-diet-select"
          onChange={(event) => handleFilterTypeDiet(event)}
        >
      ...
      <div className={Style.filterOneContainer}>
        <label className={Style.label} htmlFor="puntuation-select">
          Puntuation
        </label>
        <select
          className={Style.select}
      ...
      <div className={Style.filterOneContainer}>
        <label className={Style.label} htmlFor="filter-created-select">
          Creation
        </label>
        <select
          className={Style.select}
